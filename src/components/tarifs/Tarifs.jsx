      ...
      <div>
        ...
        <section className="bg-gradient-to-r from-gray-950 via-gray-400 to-gray-950 flex items-center justify-center ">
          ...
          <div className="grid grid-cols-5 mt-32 gap-8">
            ...
            <div className="bg-gradient-to-r from-gray-950 via-blue-400 to-gray-950  rounded-tr-3xl w-60 rounded-bl-3xl shadow-2xl p-2 animate__slideInLeft animate__slow ">
              <div className="bg-gradient-to-t from-green-800 via-green-100 to-green-800 h-20 rounded-tr-3xl w-50 rounded-bl-3xl shadow-2xl p-2"><p className="text-2xl items-center justify-content-center ml-4 p-4 font-bold">Shampooing</p></div>
              <div className="p-4 text-white py-12">
